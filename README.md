...
- ms-vscode.cpptools: Syntax highlighting and other core features for C/C++ development @github.com/microsoft/vscode-cpptools
- ms-vscode.cmake-tools: CMake core tools, build system generator tool @github.com/microsoft/vscode-cmake-tools
- twxs.cmake: CMake color highlighting @github.com/zyxar/Sublime-CMakeLists
- marus25.cortex-debug: Cortex-M debugging extension, mandatory for STM32 debug from VSCode @github.com/Marus/cortex-debug
- dan-c-underwood.arm: ARM Assembly syntax highlighter @github.com/dan-c-underwood/vscode-arm
- zixuanwang.linkerscript: GCC Linker script syntax highlighter @github.com/TheNetAdmin/vscode-linkerscript
